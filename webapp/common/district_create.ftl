...
<form action="saveDistrict.se" method="post">
    <div class="row">
        <div class="col-md-12">
            <div class="block se-block">
                ...
                <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="col-md-2 text-right"><b>Division</b></div>
                        <div class="col-md-8">
                            <select name="divisionId" class="form-control se-select" style="width: 100%;" tabindex="-1">
