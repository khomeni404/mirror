...
<div class="widget">
        ...
        <div id="printDiv" class="content scaffold-list" role="main">
            <div style="min-height: 1250px">
                <table class="headTable" id="headTable">
                    ...
                    <tr>
                        <td class="address">ad.dorpan@gmail.com</td>
                    </tr>
                </table>
                <hr/>
                <table>
                    <tr>
                        <th class="headerTitle">${parentCat} List</th>
                    </tr>
                </table>
                <br/>
                <table>
                    ...
                    <#list assetList as item>
                        <#if item.parentCategory = parentCat>
                            <#if x%2 == 0>
                            <tr class="odd">
                            <#else>
                            <tr class="even">
                            ...
                            <td class="cat">${item.itemCategory}</td>
                            <td class="price">${item.approximatePrice}/${item.unit}</td>
                            <td class="price">${item.inTotal - item.outTotal} ${item.unit}</td>
                        </tr>
                            <#assign x = x+1>
                        </#if>
    ...
    <style>
        ...
        .even {
            background-color: #d3d3d3 ; border-top: 1px solid black;border-bottom: 1px solid black;
        }

        .odd {
            background-color: #f9e3b7 ; border-top: 1px solid black;border-bottom: 1px solid black;
        }
