                ...
                <table>
                    ...
                    <#list categories as category>
                        <tr>
                            ...
                            <td class="cat">${category.description}</td>
                            <td class="cat">${category.parentItemCategory.name}</td>
                            <td class="action"><a href="deleteUnit.erp?cid=${category.id}" id="id" name="id"><img title='Edit' src='../resources/images/csd/moneyDisburse.png'/></a> </td>
                        </tr>
                    </#list>
                </table>
            </div>
