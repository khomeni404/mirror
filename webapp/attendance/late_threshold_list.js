...
Ext.onReady(function(){
    ...
    theDataStore = new Ext.data.Store({
        ...
        url: 'lateThresholdJsonData.erp',     //This is action url for getting JSON data
        reader: new Ext.data.JsonReader({
            root: 'lateThresholdList',
    ...
    listingEditorGrid = new Ext.grid.EditorGridPanel({
        ...
        columns : [
            {
                ...
                renderer: function(v,p,record){
                    renderText="";
                    if(editFeature = "edit"){
                        renderText = renderText + " <a href='updateLateThreshold.erp?id="+record.get('id')+"'><img title='Edit' src='../resources/images/edit.png'/></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                    }
                    if(deleteFeature = "delete"){
                        renderText = renderText + " <a href='deleteLateThreshold.erp?id="+record.get('id')+"'><img title='Delete' src='../resources/images/delete.png'/></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                    }
                    return renderText;
                }
        ...
        tbar: [{
            ...
            iconCls: "addRecord",
            handler:function(){
                window.location="createLateThreshold.erp"
            }
        }]
    });
