...
<div class="widget" style="width: 849px;">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 799px;height: 600px">
        <ul class="widgetlist">
            ...
            <li>
                <a href="../leave/leaveList.erp" original-title="Leave">
                    <img src="../resources/images/hrm/jobSpec.png"><span>Leave</span>
                </a>
            </li>
            <li>
                <a href="../leave/leaveEntitlementList.erp" original-title="Job Appreciation">
                    <img src="../resources/images/hrm/ico1.png"><span>Leave Entitlement</span>
                </a>
            </li>
            <li>
                <a href="../leave/leaveRegisterList.erp" original-title="Leave Register">
                    <img src="../resources/images/hrm/ico2.png"><span>Leave Register</span>
                </a>
            </li>
            <li>
                <a href="../leave/leaveWaiverList.erp" original-title="Leave Waiver">
                    <img src="../resources/images/hrm/ico1.png"><span>Leave Waiver</span>
                </a>
            </li>
