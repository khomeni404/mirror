<div class="panel panel-default" style="background-color: #d8d8d8">
    <div class="panel-body">
        <div class="row">
            <div class="col-lg-2 text-left" style="font-size: 20px; font-weight: bold;">Project List Categorization on STATUS</div>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <div class="form-group has-success">
                                <input type="text" placeholder="YYYY-MM-DD" readonly name="depositNo" id="startDate" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <div class="form-group has-success">
                                <input type="text" placeholder="YYYY-MM-DD" readonly name="depositNo" id="endDate" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                            <div class="form-group has-success" id="">
                                <select name="progressStatus" id="progressStatus-PL-2" class="form-control">
                                    <option value="null">--Select a Progress Status--</option>
                                    <option value="all">All</option>
                                    <option value="0">Not Assigned</option>
                                    <option value="1">Assigned</option>
