        ...
        <div id="ele1" class="content scaffold-list" role="main">
            <div class="headerDiv" id="headerDiv">
                ...
                <table class="headTable" id="headTable" style="border: 0px">
                    ...
                    <tr>
                        <td class="header">
                            <h2><label style="color: #1c0eff">Sales By BOD Member After last AGM</label></h2>
                        </td>
                    </tr>
                    <tr>
                        <td class="header">
            ...
            <style>
                .amt{text-align: right; padding-right: 10px; font-weight: bold}
            ...
            <div style="min-height: 1250px">
                <table style="/*margin-left: 160px;*/ ">
                    <tr style="font-weight: bold; color: #0200ff">
                        ...
                        <th style="width: 130px">MID</th>
                        <th style="width: 150px">Name</th>
                        <th style="width: 100px">Sales</th>
                        <th style="width: 100px">Sales Value (Lakh)</th>
                        <th style="width: 100px">Net Collection (Lakh)</th>
                    </tr>
                    <#assign sl = 1>
                    <#assign Sales = 0>
                    <#assign SalesValue = 0>
                    ...
                    <#list dataList as data>
                            ...
                            <tr>
                                <td class="sl">${sl}</td>
                                <td>${data.Identity.mid}</td>
                                <td>${data.Identity.name}</td>
                                <td style="text-align: center">${data.Sales}</td>
                                <td class="amt">${((data.SalesValue)/100000)?string["0.00"]}</td>
                                <td class="amt">${((data.Collected)/100000)?string["0.00"]}</td>
                    ...
                    <tr>
                        ...
                        <td class="amt">${((SalesValue)/100000)?string["0.00"]}</td>
                        <td class="amt">${((Collected)/100000)?string["0.00"]}</td>
