...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li>
                <i class="fa fa-list"></i><a href="/brtc/brtc/clientPaymentList.erp?findFor=all&status=0"> Deposit
                List</a>
            </li>
            <li>
                            ...
                            <div class="panel-body">
                                ...
                                <script type="text/javascript">
                                    ...
                                    function submitForm() {
                                        ...
                                        $.ajax({
                                            url: '/brtc/brtc/saveClientPayment.erp',
                                            data: {
                                                brtcNo: brtcNo.val(),
                                                fileNo: fileNo.val(),
                                            ...
                                            success: function (data) {
                                                if (data.success == "No") {
                                                    ...
                                                    window.location = '/brtc/brtc/clientPaymentList.erp?findFor=all&status=0'
                                                }
                                            }
                                        })
                                    ...
                                    function checkClient() {
                                        ...
                                        var brtcNo = $("#brtcNo");
                                        Ext.Ajax.request({
                                            url: '/brtc/brtc/findBrtcProject.erp',
                                            params: {
                                                fileNumber: fileNo
                                            },
